...
from common import BATCH_SIZE, DEVICE, IMAGE_SIZE, LEARNING_RATE, NUM_EPOCHS, SeasonalCurriculumSampler, calculate_sample_weights_smooth, calculate_sample_weights_01_normalized, get_image_data_transforms, get_season, print_stratification_stats, set_seed, setup_logging, calculate_count_frequency_features
...
if __name__ == '__main__':
    for stage_idx in [0, 1, 2, 3]:
        ...
        prop_col = 'season'
        train_df_imputed, weight_col = calculate_sample_weights_01_normalized(
            train_df_imputed, 
            group_col=prop_col, 
