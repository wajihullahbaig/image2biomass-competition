...
from common import BATCH_SIZE, DEVICE, IMAGE_SIZE, LEARNING_RATE, NUM_EPOCHS, get_image_data_transforms, get_season, print_stratification_stats, set_seed, setup_logging
...
if __name__ == '__main__':
    for stage_idx in [0, 1, 2, 3]:
        ...
        logger.info("Image data transformations setup...")
